...
// import userImage from '/public/5272f686-52f0-41d1-bff8-b629a4bc42cc'
  ...
  return (
    <div>
        ...
        <div className="bg-white w-full rounded-md shadow-md h-auto py-3 px-3 my-5 overflow-hidden"> 
         ...
         {post.image && <img src={post.image} className='w-full h-75 object-cover ' alt="" />}
          ...
          <div className="grid grid-cols-3 border-t border-divider pt-4 w-full px-5 my-3">
       ...
       {
        post.comments.length>0 &&    <div className='p-4  bg-gray-100 -mx-3 -mb-3'>
            ...
            <div className="flex">
              ...
              />
              <div>
                <h3 className="text-md font-semibold">{post.comments[0].commentCreator.name}</h3>
                <p className="text-xs text-gray-500">{post.comments[0].createdAt.split('.',1).join().replace('T',' ')}</p>
              </div>
            </div>
            <svg
              className="w-16"
          ...
          <p className='p-2 pb-4'>{post.comments[0].content}</p>
